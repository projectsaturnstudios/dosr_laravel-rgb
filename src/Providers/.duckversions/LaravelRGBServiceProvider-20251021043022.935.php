...
namespace RDMIntegrations\Customers\Providers;
...
class CustomersServiceProvider extends BaseServiceProvider
{
    protected string $short_name = 'customers';
    protected array $config = [
        'rdm-integrations.customers' => __DIR__ . '/../../config/customers.php',
        'database.connections.customers' => __DIR__ . '/../../config/database/connections.php',
    ];

    protected array $publishable_config = [
        ['key' => 'rdm-integrations.customers', 'file_path' => __DIR__ . '/../../config/customers.php', 'groups' => ['rdm-integrations', 'rdm-integrations.customers']],
    ];
